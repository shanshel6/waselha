...
export const TRACKING_STAGES: TrackingStage[] = [
  ...
  { key: 'sender_photos_uploaded', tKey: 'trackingSenderPhotosUploaded', icon: 'Camera', order: 3 },
  { key: 'traveler_inspection_complete', tKey: 'trackingTravelerInspectionComplete', icon: 'ShieldCheck', order: 4 },
  { key: 'traveler_on_the_way', tKey: 'trackingTravelerOnTheWay', icon: 'Plane', order: 5 },
  { key: 'delivered', tKey: 'trackingDelivered', icon: 'MapPin', order: 6 },
  { key: 'completed', tKey: 'trackingCompleted', icon: 'PackageCheck', order: 7 },
];
