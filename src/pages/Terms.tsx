      ...
      <div className="max-w-3xl mx-auto space-y-6">
        <header className="space-y-2">
          ...
          <p className="text-muted-foreground text-sm">
            يرجى قراءة هذه الشروط بعناية قبل استخدام منصة "وصلها". باستخدامك للخدمة، فإنك توافق على الالتزام بهذه الشروط وكافة السياسات المرتبطة بها.
          </p>
        </header>
        <Card>
          <CardHeader>
          ...
          <CardContent className="space-y-2 text-sm leading-relaxed">
            ...
            <p>
              المنصة ليست شركة شحن ولا تقوم بنقل الطرود بنفسها، بل توفر وسيلة تواصل وتنسيق وتتبع بين الأطراف فقط.
            </p>
          </CardContent>
        </Card>
        <Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-2 text-sm leading-relaxed">
            <ul className="list-disc pr-4 space-y-1">
              ...
              <li>المسافر ملزم بفحص الطرد قدر الإمكان قبل قبوله، وطلب صور وفحص للطرد (وهو ما يوفره النظام داخل التطبيق).</li>
        ...
        <Card>
          ...
          <CardContent className="space-y-2 text-sm leading-relaxed">
            <ul className="list-disc pr-4 space-y-1">
              <li>سعر الشحن يُقدَّر بناءً على الوزن والدولة، ويمكن تعديله بالاتفاق بين الطرفين.</li>
              <li>يتم دفع مبلغ الشحن مباشرة بين الطرفين خارج المنصة، وعند استلام الطرد.</li>
              <li>يحصل المسافر على كامل المبلغ المتفق عليه كمكافأة لنقل الطرد.</li>
              <li>المنصة لا تأخذ أي عمولة من مبلغ الشحن بين الطرفين.</li>
        ...
        <Card>
          ...
          <CardContent className="space-y-2 text-sm leading-relaxed">
            <p>
              تُقدَّم الخدمة "كما هي" بدون أي ضمانات صريحة أو ضمنية. لا تضمن المنصة:
            </p>
            <ul className="list-disc pr-4 space-y-1">
            ...
            <p>
              أنت تستخدم الخدمة على مسؤوليتك الشخصية، وتُقر بأن المنصة ليست طرفًا في التعاقد المباشر بين المسافر والمرسل.
            </p>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent className="space-y-2 text-sm leading-relaxed">
            <p>
              قد نقوم بتحديث هذه الشروط من وقت لآخر. سيتم نشر أي تعديل على هذه الصفحة، ويُعتبر استمرار استخدامك للمنصة بعد التعديل موافقة ضمنية على الشروط المحدثة.
            </p>
          </CardContent>
        </Card>
      </div>
